...
def run_bot(data_account, recover=1):
    ...
    try:
        ...
        slug = f"leaked-onlyfanss-{random_string(6)}"
        judul = f"[*[!VIDEO!]*] {kw} Onlyfans Leaked Video Viral On Social Media"
        link = f"https://apps.freeplayer.one/?title= CLICK HERE >> {kw}?ref=28C"
